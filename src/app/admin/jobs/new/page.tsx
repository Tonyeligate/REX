  ...
  return (
    <div className="admin-future-bg">
      <div className="flex items-center gap-3 mb-6">
        <Link href="/admin/jobs" className="p-2 rounded-lg hover:bg-muted transition-colors text-foreground/80">
          <ArrowLeft size={18} />
        </Link>
        <div>
          <h3 className="text-[22px] font-bold text-foreground">Create New Job</h3>
          <p className="text-[13px] text-muted-foreground">Submit a new land survey certification job</p>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
        {/* ─── Client Information ─── */}
        <div className="admin-surface-elevated rounded-xl border border-border p-6">
          <div className="flex items-center gap-2 mb-5">
            <span className="p-2 bg-[#fff7ed] rounded-lg"><User size={15} className="text-[#F07000]" /></span>
            <div>
              <p className="text-[14px] font-bold text-foreground">Client Information</p>
              <p className="text-[12px] text-muted-foreground">Details about the client commissioning this job</p>
            </div>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            {/* Client Name */}
            <div className="md:col-span-2">
              <label className="block text-[13px] font-semibold text-foreground/85 mb-1.5">Client Name *</label>
              <input
            ...
            {/* Phone */}
            <div>
              <label className="block text-[13px] font-semibold text-foreground/85 mb-1.5">Contact Phone</label>
              <input
            ...
            {/* Email */}
            <div>
              <label className="block text-[13px] font-semibold text-foreground/85 mb-1.5">Contact Email</label>
              <input
        ...
        <div className="admin-surface-elevated rounded-xl border border-border p-6">
          <div className="flex items-center gap-2 mb-5">
            ...
            <div>
              <p className="text-[14px] font-bold text-foreground">Job Details</p>
              <p className="text-[12px] text-muted-foreground">Technical information about the survey job</p>
            </div>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            {/* Regional Number */}
            ...
            {/* Job Title / Reference */}
            <div>
              <label className="block text-[13px] font-semibold text-foreground/85 mb-1.5">Job Reference / Title</label>
              <input
                {...register("title")}
                placeholder="e.g. Plot 45 East Legon"
                className="w-full h-[40px] px-4 border border-border bg-card rounded-lg text-[13px] text-foreground focus:outline-none focus:ring-2 focus:ring-[#F07000]/20"
              />
              <p className="text-[11px] text-muted-foreground mt-1">Combined as: Client Name – Job Reference</p>
            </div>

            {/* Description */}
            <div className="md:col-span-2">
              <label className="block text-[13px] font-semibold text-foreground/85 mb-1.5">Description / Notes</label>
              <textarea
                {...register("description")}
                placeholder="Describe the job details, location, or any instructions..."
                rows={3}
                className="w-full px-4 py-2 border border-border bg-card rounded-lg text-[13px] text-foreground focus:outline-none focus:ring-2 focus:ring-[#F07000]/20 resize-none"
              />
            </div>

            {/* Parcel Acreage */}
            <div>
              <label className="block text-[13px] font-semibold text-foreground/85 mb-1.5">Parcel Acreage</label>
              <input
        ...
        <div className="flex items-center justify-end gap-3">
          <Link href="/admin/jobs" className="h-[40px] px-5 flex items-center rounded-lg border border-border bg-card text-[13px] font-semibold text-foreground/85 hover:bg-muted">
            Cancel
          </Link>
          <button
            type="submit"
