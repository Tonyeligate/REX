    ...
    <footer className="px-4 py-3 mt-auto">
      <div className="flex flex-col md:flex-row items-center justify-between border-t pt-3">
        ...
        <ul className="flex items-center gap-4 list-none p-0">
          <li><a href="#" className="text-[13px] text-[#4b5563] hover:text-[#F07000]">Support</a></li>
          <li><a href="#" className="text-[13px] text-[#4b5563] hover:text-[#F07000]">Docs</a></li>
          <li><a href="#" className="text-[13px] text-[#4b5563] hover:text-[#F07000]">Contact Us</a></li>
        </ul>
      </div>
    </footer>
  );
